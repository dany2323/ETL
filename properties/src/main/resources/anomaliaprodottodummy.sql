insert into dmalm_anomalia_prodotto_dummy
 select DMALM_ANM_PROD_DUMMY_SEQ.nextval, DMALM_STRUTTURA_ORG_FK_01, DMALM_PROJECT_FK_02, DMALM_STATO_WORKITEM_FK_03, TEMPO_PK, DMALM_AREA_TEMATICA_FK_05, CD_ANOMALIA, 
        ...
        RANK_STATO_ANOMALIA_MESE, STG_PK, ANNULLATO, DESCRIZIONE_ANOMALIA, DMALM_USER_FK_06, URI_ANOMALIA_PRODOTTO, CHANGED, 0 AS FL_ULTIMA_SITUAZIONE, DT_ANNULLAMENTO, CONTESTAZIONE, 
        NOTE_CONTESTAZIONE, DATA_DISPONIBILITA, PRIORITY, TAG_ALM, TS_TAG_ALM
 from (
