...
insert into DMALM_CALIPSO_AMBT_SCHED_SERVZ ( select * from T_DMALM_CALIPSO_AMB_SCHED_SERV);
insert into DMALM_CALIPSO_SCH_SERVZ_PERSNL ( select * from T_DMALM_CALIPSO_SCH_SERV_PERSN);
insert into DMALM_CALIPSO_SCH_SUPP_MAN_SW ( select * from T_DMALM_CALIPSO_SCH_SUP_MAN_SW);