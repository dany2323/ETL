...
public class DmAlmMpsContrattiDAO {
	...
	public static void insertMpsContrattie(Timestamp dataEsecuzione,
		...
		try {
			...
			insert.columns(mpsContratti.idContratto,
					mpsContratti.codContratto,
					mpsContratti.titoloContratto,
					mpsContratti.annoRiferimento,
					mpsContratti.dataInizio,
					mpsContratti.dataFine,
					mpsContratti.tipo,
					mpsContratti.stato,
					mpsContratti.firmaDigitale,
					mpsContratti.variato,
					mpsContratti.numVariazioni,
					mpsContratti.codDirezione,
					mpsContratti.desDirezione,
					mpsContratti.codUo,
					mpsContratti.desUo,
					mpsContratti.codStruttura,
					mpsContratti.desStruttura,
					mpsContratti.totaleContratto,
					mpsContratti.totaleImpegnato,
					mpsContratti.totaleSpalmato,
					mpsContratti.totaleVerbalizzato,
					mpsContratti.totaleRichiesto,
					mpsContratti.totaleFatturato,
					mpsContratti.totaleFatturabile,
					mpsContratti.prossimoFirmatario,
					mpsContratti.inCorsoIl,
					mpsContratti.numeroRilasci,
					mpsContratti.numeroRilasciForfait,
					mpsContratti.numeroRilasciCanone,
					mpsContratti.numeroRilasciConsumo,
					mpsContratti.numeroVerbali,
					mpsContratti.numeroVerbaliForfait,
					mpsContratti.numeroVerbaliConsumo,
					mpsContratti.desMotivoVariazione,
					mpsContratti.repository,
					mpsContratti.priorita,
					mpsContratti.idSm,
					mpsContratti.serviceManager)
			.values(mpsContrattie.getIdContratto(),
					mpsContrattie.getCodContratto(),
					mpsContrattie.getTitoloContratto(),
					mpsContrattie.getAnnoRiferimento(),
					mpsContrattie.getDataInizio(),
					mpsContrattie.getDataFine(),
					mpsContrattie.getTipo(),
					mpsContrattie.getStato(),
					mpsContrattie.getFirmaDigitale(),
					mpsContrattie.getVariato(),
					mpsContrattie.getNumVariazioni(),
					mpsContrattie.getCodDirezione(),
					mpsContrattie.getDesDirezione(),
					mpsContrattie.getCodUo(),
					mpsContrattie.getDesUo(),
					mpsContrattie.getCodStruttura(),
					mpsContrattie.getDesStruttura(),
					mpsContrattie.getTotaleContratto(),
					mpsContrattie.getTotaleImpegnato(),
					mpsContrattie.getTotaleSpalmato(),
					mpsContrattie.getTotaleVerbalizzato(),
					mpsContrattie.getTotaleRichiesto(),
					mpsContrattie.getTotaleFatturato(),
					mpsContrattie.getTotaleFatturabile(),
					mpsContrattie.getProssimoFirmatario(),
					mpsContrattie.getInCorsoIl(),
					mpsContrattie.getNumeroRilasci(),
					mpsContrattie.getNumeroRilasciForfait(),
					mpsContrattie.getNumeroRilasciCanone(),
					mpsContrattie.getNumeroRilasciConsumo(),
					mpsContrattie.getNumeroVerbali(),
					mpsContrattie.getNumeroVerbaliForfait(),
					mpsContrattie.getNumeroVerbaliConsumo(),
					mpsContrattie.getDesMotivoVariazione(),
					mpsContrattie.getRepository(),
					mpsContrattie.getPriorita(),
					mpsContrattie.getIdSm(),
					mpsContrattie.getServiceManager()).execute();
