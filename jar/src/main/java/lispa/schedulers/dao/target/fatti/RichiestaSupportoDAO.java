...
public class RichiestaSupportoDAO {
	...
	public static List<DmalmRichiestaSupporto> getAllRichiestaSupporto(
		...
		try {
			...
			String sql = QueryUtils.getCallFunction(
					"RICHIESTA_SUPPORTO.GET_ALL_RICHIESTA_SUPPORTO", 1);
			try (CallableStatement cs = connection.prepareCall(sql);) {
				...
				try (ResultSet rs = (ResultSet) cs.getObject(1);) {
					...
					while (rs.next()) {
						...
						bean.setUriRichiestaSupporto(
								rs.getString("URI_RICHIESTA_SUPPORTO"));
						bean.setDmalmRichiestaSupportoPk(
						...
						bean.setDataRisoluzioneRichSupporto(rs.getTimestamp(
								"DATA_RISOLUZIONE_RICH_SUPPORTO"));
						bean.setNrGiorniFestivi(rs.getInt("NR_GIORNI_FESTIVI"));
						bean.setTempoTotRichSupporto(
								rs.getInt("TEMPO_TOT_RICH_SUPPORTO"));
						bean.setDmalmStatoWorkitemFk03(
								rs.getInt("DMALM_STATO_WORKITEM_FK_03"));
						bean.setDataCreazRichSupporto(
								rs.getTimestamp("DATA_CREAZ_RICH_SUPPORTO"));
						bean.setDataModificaRecord(
								rs.getTimestamp("DATA_MODIFICA_RECORD"));
						bean.setDataChiusRichSupporto(
								rs.getTimestamp("DATA_CHIUS_RICH_SUPPORTO"));
						bean.setUseridRichSupporto(
								rs.getString("USERID_RICH_SUPPORTO"));
						bean.setNomeRichSupporto(
								rs.getString("NOME_RICH_SUPPORTO"));
						bean.setMotivoRisoluzione(
								rs.getString("MOTIVO_RISOLUZIONE"));
						bean.setSeverityRichSupporto(
								rs.getString("SEVERITY_RICH_SUPPORTO"));
						bean.setDescrizioneRichSupporto(
								rs.getString("DESCRIZIONE_RICH_SUPPORTO"));
						bean.setNumeroTestataRdi(
								rs.getString("NUMERO_TESTATA_RDI"));
						bean.setDataDisponibilita(
								rs.getTimestamp("DATA_DISPONIBILITA"));
						bean.setPriorityRichSupporto(
								rs.getString("PRIORITY_RICH_SUPPORTO"));
						bean.setCodiceArea(rs.getString("CODICE_AREA"));
						bean.setCodiceProdotto(rs.getString("CODICE_PRODOTTO"));
						bean.setDtScadenzaRichiestaSupporto(
								rs.getTimestamp("DATA_SCADENZA"));
	...
	public static List<DmalmRichiestaSupporto> getRichiestaSupporto(
			DmalmRichiestaSupporto richiesta)
		...
		try {
			...
			String sql = QueryUtils.getCallFunction(
					"RICHIESTA_SUPPORTO.GET_RICHIESTA_SUPPORTO", 1);
			Object[] objRichSupp = richiesta.getObject(richiesta, true);
			Struct structObj = connection.createStruct("RICHSUPPTYPE",
					objRichSupp);
			try (OracleCallableStatement ocs = (OracleCallableStatement) connection
				...
				try (ResultSet rs = (ResultSet) ocs.getObject(1);) {
					while (rs.next()) {
						...
						bean.setNumeroTestataRdi(
								rs.getString("NUMERO_TESTATA_RDI"));
						bean.setRankStatoRichSupporto(
								rs.getInt("RANK_STATO_RICH_SUPPORTO"));
						bean.setDataDisponibilita(
								rs.getTimestamp("DATA_DISPONIBILITA"));
						bean.setPriorityRichSupporto(
								rs.getString("PRIORITY_RICH_SUPPORTO"));
	...
	public static void insertRichiestaSupporto(DmalmRichiestaSupporto richiesta,
		...
		try {
			...
			String sql = QueryUtils.getCallProcedure(
					"RICHIESTA_SUPPORTO.INSERT_RICHIESTA_SUPPORTO", 2);
			Object[] objRichSupp = richiesta.getObject(richiesta, true);
			Struct structObj = connection.createStruct("RICHSUPPTYPE",
					objRichSupp);
			try (OracleCallableStatement ocs = (OracleCallableStatement) connection
	...
	public static void updateRank(DmalmRichiestaSupporto richiesta,
			Double double1) throws DAOException, SQLException {
		...
		try {
			...
			String sql = QueryUtils
					.getCallProcedure("RICHIESTA_SUPPORTO.UPDATE_RANK", 2);
			Object[] objRichSupp = richiesta.getObject(richiesta, true);
			Struct structObj = connection.createStruct("RICHSUPPTYPE",
					objRichSupp);
			try (OracleCallableStatement ocs = (OracleCallableStatement) connection
	...
	public static void insertRichiestaSupportoUpdate(Timestamp dataEsecuzione,
		...
		try {
			...
			String sql = QueryUtils.getCallProcedure(
					"RICHIESTA_SUPPORTO.INSERT_UPDATE_RICH_SUPPORTO", 2);
	...
	public static void updateRichiestaSupporto(DmalmRichiestaSupporto richiesta)
		...
		try {
			...
			String sql = QueryUtils.getCallProcedure(
					"RICHIESTA_SUPPORTO.UPDATE_RICH_SUPPORTO", 1);
			Object[] objRichSupp = richiesta.getObject(richiesta, true);
			Struct structObj = connection.createStruct("RICHSUPPTYPE",
					objRichSupp);
			try (OracleCallableStatement ocs = (OracleCallableStatement) connection
	...
	public static DmalmRichiestaSupporto getRichiestaSupporto(Integer pk)
		...
		try {
			...
			String sql = QueryUtils.getCallFunction(
					"RICHIESTA_SUPPORTO.GET_RICHIESTA_SUPPORTO_BY_PK", 1);
			...
			try (OracleCallableStatement ocs = (OracleCallableStatement) connection
				...
				try (ResultSet rs = (ResultSet) ocs.getObject(1);) {
					...
					while (rs.next()) {
						...
						bean.setDataAnnullamento(
								rs.getTimestamp("DATA_ANNULLAMENTO"));
						bean.setDataStoricizzazione(
								rs.getTimestamp("DT_STORICIZZAZIONE"));
						bean.setCodiceArea(rs.getString("CODICE_AREA"));
						bean.setCodiceProdotto(rs.getString("CODICE_PRODOTTO"));
						bean.setDtScadenzaRichiestaSupporto(
								rs.getTimestamp("DATA_SCADENZA"));
			...
			switch (typeQuery) {
				case 0 :
					sql = QueryUtils.getCallFunction(
							"RICHIESTA_SUPPORTO.GET_PK_RICH_SUPP_BY_PK_HIS", 1);
					break;
				case 1 :
					sql = QueryUtils.getCallFunction(
							"RICHIESTA_SUPPORTO.GET_PK_RICH_SUPP_BY_PK_HIS_SUB",
							1);
					break;
				default :
					break;
	...
	public static void updateWIRichiestaSupportoDeleted(
			DmalmRichiestaSupporto richiesta, Timestamp dataEsecuzione)
			throws DAOException, SQLException {
		...
		try {
			...
			String sql = QueryUtils.getCallProcedure(
					"RICHIESTA_SUPPORTO.UPDATE_WI_RICH_SUPPORTO_DELETE", 2);
			Object[] objRichSupp = richiesta.getObject(richiesta, true);
			// StructDescriptor structDesc =
			// StructDescriptor.createDescriptor(DmAlmConstants.DMALM_TARGET_SCHEMA.toUpperCase()+".RICHSUPPTYPE",
			// connection);
			// STRUCT structObj = new STRUCT(structDesc, connection,
			// objRichSupp);
			Struct structObj = connection.createStruct("RICHSUPPTYPE",
					objRichSupp);
			try (OracleCallableStatement ocs = (OracleCallableStatement) connection
	...
	public static boolean checkEsistenzaRichiestaSupporto(
			DmalmRichiestaSupporto richiesta, DmalmProject p)
			throws DAOException, SQLException {
		...
		try {
			...
			String sql = QueryUtils.getCallFunction(
					"RICHIESTA_SUPPORTO.CHECK_ESISTENZA_RICH_SUPPORTO", 2);
			Object[] objRichSupp = richiesta.getObject(richiesta, true);
			// StructDescriptor structDesc =
			// StructDescriptor.createDescriptor(DmAlmConstants.DMALM_TARGET_SCHEMA.toUpperCase()+".RICHSUPPTYPE",
			// connection);
	...
	public static void checkAlteredRichiestaSupporto(
			List<DmalmRichiestaSupporto> richieste, Timestamp dataEsecuzione)
			throws DAOException, SQLException {
		...
		try {
			...
			String sql = QueryUtils.getCallProcedure(
					"RICHIESTA_SUPPORTO.CHECK_ALTERED_ROW_RICH_SUPP", 2);
