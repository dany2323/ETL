	...
	public static void insert(
		...
		try {
			...
			for (DmalmProgettoSviluppoSvil progetto : staging_progettoSviluppoSvil) {
				if(listPk.contains(progetto.getDmalmProgSvilSPk()))
					logger.info("Trovata DmalmProgSvilSPk DUPLICATA!!!"+progetto.getDmalmProgSvilSPk());
				else{
					listPk.add(progetto.getDmalmProgSvilSPk());
