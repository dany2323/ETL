	...
	public static List<DmalmLinkedWorkitems> getStartWorkitemsTemplateSviluppo(
		...
		try {
			...
			resultList = query
					...
					.join(releaseDiProgetto)
					.on(releaseDiProgetto.cdReleasediprog.eq(link.codiceProjectPadre)
						.and(releaseDiProgetto.idRepository.eq(link.idRepositoryPadre)))
	...
	public static List<DmalmLinkedWorkitems> getStartWorkitemsTemplateAssFunzionale(
		...
		try {
			...
			resultList = query
					...
					.where(link.tipoWiPadre.in("anomalia_assistenza","richiesta_gestione"))
					.where(link.tipoWiFiglio.in("richiesta_gestione","anomalia_assistenza"))
					.where(link.ruolo.isNotNull())
