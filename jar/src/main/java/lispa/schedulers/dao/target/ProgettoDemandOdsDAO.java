	...
	public static void insert(List<DmalmProgettoDemand> staging_progettoDemand,
		...
		try {
			...
			for (DmalmProgettoDemand progettoDemand : staging_progettoDemand) {
				if(listPk.contains(progettoDemand.getDmalmProgettoDemandPk()))
					logger.info("Trovata DmalmProgettoDemandPk DUPLICATA!!!"+progettoDemand.getDmalmProgettoDemandPk());
				else{
					listPk.add(progettoDemand.getDmalmProgettoDemandPk());
