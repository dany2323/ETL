...
public class FilieraTemplateIntTecnicaDAO {
	...
	public static void delete() throws DAOException, SQLException {
		...
		try {
			...
			QDmalmFilieraTemplateIntTecnica filieraIntTecnica = QDmalmFilieraTemplateIntTecnica.dmalmFilieraTemplateIntTecnica;

			SQLTemplates dialect = new HSQLDBTemplates();

			new SQLDeleteClause(connection, dialect, filieraIntTecnica)
					.execute();
	...
	public static void insert(Integer idFiliera, Integer livello,
		...
		try {
			...
			QDmalmFilieraTemplateIntTecnica filiera = QDmalmFilieraTemplateIntTecnica.dmalmFilieraTemplateIntTecnica;
