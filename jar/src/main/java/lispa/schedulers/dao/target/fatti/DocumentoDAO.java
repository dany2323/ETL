...
public class DocumentoDAO {
	...
	public static List<DmalmDocumento> getAllDocumento(Timestamp dataEsecuzione)
		...
		try {
			...
			while (rs.next()) {
				...
				bean.setDmalmDocumentoPk(rs.getLong("DMALM_DOCUMENTO_PK"));
	...
	public static DmalmDocumento getDocumento(Long pk) throws DAOException {
	...
	public static boolean checkEsistenzaDocumento(DmalmDocumento d,
		...
		List<Tuple> documenti = new ArrayList<>();
