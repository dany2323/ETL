...
public class CalipsoSchedaServizioDAO {
	...
	public static int getRigheInseriteModificateSchedaServizio(String table, Timestamp dataCaricamento)  throws DAOException, SQLException {
		int righe = 0;
		ConnectionManager cm = null;
		Connection connection = null;
		CallableStatement cs = null;
		...
		try {
			...
			connection.setAutoCommit(false);
			String sql = QueryUtils.getCallFunction("CALIPSO.GET_RIGHE_INSERITE", 2);
