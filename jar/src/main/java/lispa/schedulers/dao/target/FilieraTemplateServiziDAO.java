...
import lispa.schedulers.queryimplementation.target.QDmalmFilieraTemplateServizi;
...
public class FilieraTemplateServiziDAO {
	...
	public static void delete() throws DAOException, SQLException {
		...
		try {
			...
			QDmalmFilieraTemplateServizi filieraServizi = QDmalmFilieraTemplateServizi.dmalmFilieraTemplateServizi;

			SQLTemplates dialect = new HSQLDBTemplates();

			new SQLDeleteClause(connection, dialect, filieraServizi)
					.execute();
	...
	public static void insert(Integer idFiliera, Integer livello,
		...
		try {
			...
			QDmalmFilieraTemplateServizi filiera = QDmalmFilieraTemplateServizi.dmalmFilieraTemplateServizi;
			...
			if (fkDocumento != null){
				FilieraTemplateDocumentiDAO.insert (DmAlmConstants.SERDEP, idFiliera, livello, linkedWorkitem.getFkWiPadre(), linkedWorkitem.getTipoWiPadre(), fkDocumento);
			}
			...
			if (lastWorkitem) {
				...
				if (fkDocumento != null){
					FilieraTemplateDocumentiDAO.insert (DmAlmConstants.SERDEP, idFiliera, livello, linkedWorkitem.getFkWiFiglio(), linkedWorkitem.getTipoWiFiglio(), fkDocumento);
				}
			}
