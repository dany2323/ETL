...
/**
 * SireCurrentCfWorkitem is a Querydsl bean type
 */
@Generated("com.mysema.query.codegen.BeanSerializer")
public class SireCurrentCfWorkitem {
    ...
    private java.sql.Timestamp cDateonlyValue;

    private Long cDurationtimeValue;
    ...
    public java.sql.Timestamp getcDateonlyValue() {
        return cDateonlyValue;
    }

    public void setcDateonlyValue(java.sql.Timestamp cDateonlyValue) {
        this.cDateonlyValue = cDateonlyValue;
    }

    public Long getcDurationtimeValue() {
        return cDurationtimeValue;
    }

    public void setcDurationtimeValue(Long cDurationtimeValue) {
