...
public class DmalmElPersonale {
	
	private Integer personalePk;
	...
	public void setPersonalePk(Integer personalePk) {
		this.personalePk = personalePk;
	}
	...
	public String getCodicePersonale() {
		return codicePersonale;
	}
	public void setCodicePersonale(String codicePersonale) {
