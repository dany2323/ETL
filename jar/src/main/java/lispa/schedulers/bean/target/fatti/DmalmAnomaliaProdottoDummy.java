...
/**
 * DmalmAnomaliaProdottoDummy is a Querydsl bean type
 */
@Generated("com.mysema.query.codegen.BeanSerializer")
public class DmalmAnomaliaProdottoDummy {
	...
	public void setDtCambioStatoAnomalia(
			java.sql.Timestamp dtCambioStatoAnomalia) {
	...
	public void setDtCaricamentoRecordAnomalia(
			java.sql.Timestamp dtCaricamentoRecordAnomalia) {
	...
	public void setDtModificaRecordAnomalia(
			java.sql.Timestamp dtModificaRecordAnomalia) {
	...
	public void setDtRisoluzioneAnomalia(
			java.sql.Timestamp dtRisoluzioneAnomalia) {
	...
	public void setTempoTotRisoluzioneAnomalia(
			Integer tempoTotRisoluzioneAnomalia) {
