...
import lispa.schedulers.bean.staging.mps.DmalmStgMpsContratti;
...
public class QDmalmStgMpsContratti extends
		com.mysema.query.sql.RelationalPathBase<DmalmStgMpsContratti> {
