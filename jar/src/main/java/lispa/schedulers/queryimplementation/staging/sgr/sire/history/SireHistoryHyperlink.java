...
public class SireHistoryHyperlink extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryHyperlink> {
    ...
    public SireHistoryHyperlink(String variable) {
        super(lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryHyperlink.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SIRE_STRUCT_WI_HYLINK");
    }

    public SireHistoryHyperlink(Path<? extends lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryHyperlink> path) {
    ...
    public SireHistoryHyperlink(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryHyperlink.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SIRE_STRUCT_WI_HYLINK");
    }
