...
public class SireHistoryWorkitem extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryWorkitem> {
    ...
    public SireHistoryWorkitem(String variable) {
        super(lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryWorkitem.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SIRE_WORKITEM");
    }

    public SireHistoryWorkitem(Path<? extends lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryWorkitem> path) {
    ...
    public SireHistoryWorkitem(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.staging.sgr.sire.history.DmAlmSireHistoryWorkitem.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SIRE_WORKITEM");
    }
