...
/**
 * DmAlmMisura is a Querydsl query type for DmalmStgMisura
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class DmAlmMisura extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sfera.DmAlmMisura> {

    private static final long serialVersionUID = -1808180199;

    public static final DmAlmMisura dmalmStgMisura = new DmAlmMisura("DM_ALM_MISURA");
    ...
    public DmAlmMisura(String variable) {
        super(lispa.schedulers.bean.staging.sfera.DmAlmMisura.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MISURA");
    }

    public DmAlmMisura(Path<? extends lispa.schedulers.bean.staging.sfera.DmAlmMisura> path) {
        super(path.getType(), path.getMetadata(), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MISURA");
    }

    public DmAlmMisura(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.staging.sfera.DmAlmMisura.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MISURA");
    }
