...
public class DmAlmWorkitemLinkRoles extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sgr.xml.DmAlmWorkitemLinkRoles> {
    ...
    public DmAlmWorkitemLinkRoles(String variable) {
        super(lispa.schedulers.bean.staging.sgr.xml.DmAlmWorkitemLinkRoles.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_WORKITEM_LINK_ROLES");
    }

    public DmAlmWorkitemLinkRoles(Path<? extends lispa.schedulers.bean.staging.sgr.xml.DmAlmWorkitemLinkRoles> path) {
    ...
    public DmAlmWorkitemLinkRoles(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.staging.sgr.xml.DmAlmWorkitemLinkRoles.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_WORKITEM_LINK_ROLES");
    }
