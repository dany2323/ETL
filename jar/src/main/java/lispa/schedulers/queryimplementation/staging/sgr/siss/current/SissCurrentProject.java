...
public class SissCurrentProject extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sgr.siss.current.DmAlmSissCurrentProject> {
    ...
    public final com.mysema.query.sql.PrimaryKey<lispa.schedulers.bean.staging.sgr.siss.current.DmAlmSissCurrentProject> projectPk = createPrimaryKey(cPk);

    public SissCurrentProject(String variable) {
        super(lispa.schedulers.bean.staging.sgr.siss.current.DmAlmSissCurrentProject.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_C_SISS_PROJECT");
    }

    public SissCurrentProject(Path<? extends lispa.schedulers.bean.staging.sgr.siss.current.DmAlmSissCurrentProject> path) {
    ...
    public SissCurrentProject(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.staging.sgr.siss.current.DmAlmSissCurrentProject.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_C_SISS_PROJECT");
    }
