...
public class SissHistoryWorkitem extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sgr.siss.history.DmAlmSissHistoryWorkitem> {
    ...
    public SissHistoryWorkitem(String variable) {
        super(lispa.schedulers.bean.staging.sgr.siss.history.DmAlmSissHistoryWorkitem.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SISS_WORKITEM");
    }

    public SissHistoryWorkitem(Path<? extends lispa.schedulers.bean.staging.sgr.siss.history.DmAlmSissHistoryWorkitem> path) {
    ...
    public SissHistoryWorkitem(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.staging.sgr.siss.history.DmAlmSissHistoryWorkitem.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SISS_WORKITEM");
    }
