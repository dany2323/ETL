...
public class DmAlmStatoWorkitem extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sgr.xml.DmAlmStatoWorkitem> {
    ...
    public DmAlmStatoWorkitem(String variable) {
        super(lispa.schedulers.bean.staging.sgr.xml.DmAlmStatoWorkitem.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_STATO_WORKITEM_SVN");
    }

    public DmAlmStatoWorkitem(Path<? extends lispa.schedulers.bean.staging.sgr.xml.DmAlmStatoWorkitem> path) {
    ...
    public DmAlmStatoWorkitem(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.staging.sgr.xml.DmAlmStatoWorkitem.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_STATO_WORKITEM_SVN");
    }
