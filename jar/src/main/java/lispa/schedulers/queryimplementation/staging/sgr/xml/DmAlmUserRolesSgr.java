...
public class DmAlmUserRolesSgr extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.staging.sgr.xml.DmAlmUserRolesSgr> {
    ...
    public DmAlmUserRolesSgr(Path<? extends lispa.schedulers.bean.staging.sgr.xml.DmAlmUserRolesSgr> path) {
