...
public class SireCurrentSubterraUriMap extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.sgr.sire.current.SireCurrentSubterraUriMap> {
    ...
    public SireCurrentSubterraUriMap(String variable) {
        super(lispa.schedulers.bean.fonte.sgr.sire.current.SireCurrentSubterraUriMap.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_C_SIRE_SUBTERRA_URI_MAP");
    }
    ...
    public SireCurrentSubterraUriMap(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.fonte.sgr.sire.current.SireCurrentSubterraUriMap.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_C_SIRE_SUBTERRA_URI_MAP");
    }
