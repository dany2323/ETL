...
public class HistoryUser extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.sgr.history.HistoryUser> {

    private static final long serialVersionUID = 690289880;
    
    public static final HistoryUser user = new HistoryUser("T_USER");
    ...
    public HistoryUser(String variable) {
        super(lispa.schedulers.bean.fonte.sgr.history.HistoryUser.class, forVariable(variable), DmAlmConstants.POLARION_SCHEMA, "T_USER");
    }

    public HistoryUser(Path<? extends lispa.schedulers.bean.fonte.sgr.history.HistoryUser> path) {
        super(path.getType(), path.getMetadata(), DmAlmConstants.POLARION_SCHEMA, "T_USER");
    }

    public HistoryUser(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.fonte.sgr.history.HistoryUser.class, metadata, DmAlmConstants.POLARION_SCHEMA, "T_USER");
    }
