...
public class SissHistoryCfWorkitem extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.sgr.siss.history.SissHistoryCfWorkitem> {
    ...
    public SissHistoryCfWorkitem(String variable) {
        super(lispa.schedulers.bean.fonte.sgr.siss.history.SissHistoryCfWorkitem.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SISS_CF_WORKITEM");
    }
    ...
    public SissHistoryCfWorkitem(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.fonte.sgr.siss.history.SissHistoryCfWorkitem.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_H_SISS_CF_WORKITEM");
    }
