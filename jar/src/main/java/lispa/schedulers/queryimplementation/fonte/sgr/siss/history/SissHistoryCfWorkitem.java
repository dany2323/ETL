...
public class SissHistoryCfWorkitem extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.sgr.siss.history.SissHistoryCfWorkitem> {

    private static final long serialVersionUID = -917026934;

    public static final SissHistoryCfWorkitem cfWorkitem = new SissHistoryCfWorkitem("CF_WORKITEM");
    ...
    public SissHistoryCfWorkitem(String variable) {
        super(lispa.schedulers.bean.fonte.sgr.siss.history.SissHistoryCfWorkitem.class, forVariable(variable), DmAlmConstants.POLARION_SCHEMA, "CF_WORKITEM");
    }

    public SissHistoryCfWorkitem(Path<? extends lispa.schedulers.bean.fonte.sgr.siss.history.SissHistoryCfWorkitem> path) {
    ...
    public SissHistoryCfWorkitem(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.fonte.sgr.siss.history.SissHistoryCfWorkitem.class, metadata, DmAlmConstants.POLARION_SCHEMA, "CF_WORKITEM");
    }
