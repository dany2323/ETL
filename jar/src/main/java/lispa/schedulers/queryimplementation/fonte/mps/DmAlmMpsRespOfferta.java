...
public class DmAlmMpsRespOfferta extends
		com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.mps.DmAlmMpsRespOfferta> {

	private static final long serialVersionUID = -4895584109351088017L;

	public static final DmAlmMpsRespOfferta dmalmMpsRespOfferta = new DmAlmMpsRespOfferta(
	...
	public DmAlmMpsRespOfferta(String variable) {
		super(lispa.schedulers.bean.fonte.mps.DmAlmMpsRespOfferta.class, forVariable(variable),
				DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MPS_RESPON_OFFERTA");
	}

	public DmAlmMpsRespOfferta(Path<? extends lispa.schedulers.bean.fonte.mps.DmAlmMpsRespOfferta> path) {
		super(path.getType(), path.getMetadata(),
				DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MPS_RESPON_OFFERTA");
	}

	public DmAlmMpsRespOfferta(PathMetadata<?> metadata) {
		super(lispa.schedulers.bean.fonte.mps.DmAlmMpsRespOfferta.class, metadata,
				DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MPS_RESPON_OFFERTA");
	}
