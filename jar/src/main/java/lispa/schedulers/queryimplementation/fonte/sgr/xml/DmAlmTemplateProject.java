...
public class DmAlmTemplateProject extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.sgr.xml.DmAlmTemplateProject> {
    ...
    public DmAlmTemplateProject(String variable) {
        super(lispa.schedulers.bean.fonte.sgr.xml.DmAlmTemplateProject.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_TEMPLATE_PROJECT");
    }

    public DmAlmTemplateProject(Path<? extends lispa.schedulers.bean.fonte.sgr.xml.DmAlmTemplateProject> path) {
    ...
    public DmAlmTemplateProject(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.fonte.sgr.xml.DmAlmTemplateProject.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_TEMPLATE_PROJECT");
    }
