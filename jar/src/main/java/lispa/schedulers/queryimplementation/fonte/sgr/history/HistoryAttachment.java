...
public class HistoryAttachment extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.sgr.history.HistoryAttachment> {

    private static final long serialVersionUID = -1678920117;

    public static final HistoryAttachment attachment = new HistoryAttachment("ATTACHMENT");
    ...
    public final com.mysema.query.sql.PrimaryKey<lispa.schedulers.bean.fonte.sgr.history.HistoryAttachment> constraintA = createPrimaryKey(cPk);

    public HistoryAttachment(String variable) {
        super(lispa.schedulers.bean.fonte.sgr.history.HistoryAttachment.class, forVariable(variable), DmAlmConstants.POLARION_SCHEMA, "ATTACHMENT");
    }

    public HistoryAttachment(Path<? extends lispa.schedulers.bean.fonte.sgr.history.HistoryAttachment> path) {
        super(path.getType(), path.getMetadata(), DmAlmConstants.POLARION_SCHEMA, "ATTACHMENT");
    }

    public HistoryAttachment(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.fonte.sgr.history.HistoryAttachment.class, metadata, DmAlmConstants.POLARION_SCHEMA, "ATTACHMENT");
    }
