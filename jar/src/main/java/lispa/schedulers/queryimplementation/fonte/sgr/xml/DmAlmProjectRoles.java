...
public class DmAlmProjectRoles extends com.mysema.query.sql.RelationalPathBase<lispa.schedulers.bean.fonte.sgr.xml.DmAlmProjectRoles> {
    ...
    public DmAlmProjectRoles(String variable) {
        super(lispa.schedulers.bean.fonte.sgr.xml.DmAlmProjectRoles.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_PROJECT_ROLES");
    }

    public DmAlmProjectRoles(Path<? extends lispa.schedulers.bean.fonte.sgr.xml.DmAlmProjectRoles> path) {
    ...
    public DmAlmProjectRoles(PathMetadata<?> metadata) {
        super(lispa.schedulers.bean.fonte.sgr.xml.DmAlmProjectRoles.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_PROJECT_ROLES");
    }
