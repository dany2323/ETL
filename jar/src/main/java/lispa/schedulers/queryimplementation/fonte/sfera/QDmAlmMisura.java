package lispa.schedulers.queryimplementation.fonte.sfera;

import static com.mysema.query.types.PathMetadataFactory.*;

import lispa.schedulers.bean.fonte.sfera.DmAlmMisura;
...
public class QDmAlmMisura extends com.mysema.query.sql.RelationalPathBase<DmAlmMisura> {
    ...
    public static final QDmAlmMisura dmAlmMisura = new QDmAlmMisura("DM_ALM_MISURA");
...
//    public final DateTimePath<java.sql.Timestamp> dataCaricamento = createDateTime("DT_CARICAMENTO", java.sql.Timestamp.class);
    ...
    public QDmAlmMisura(String variable) {
        super(DmAlmMisura.class, forVariable(variable), DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MISURA");
    }
    ...
    public QDmAlmMisura(PathMetadata<?> metadata) {
        super(DmAlmMisura.class, metadata, DmAlmConstants.DMALM_STAGING_SCHEMA, "DM_ALM_MISURA");
    }
