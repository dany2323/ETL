...
public class QDmalmElProdottiArchitetture extends com.mysema.query.sql.RelationalPathBase<DmalmElProdottiArchitetture> {
	...
	public final NumberPath<Integer> unitaOrgFlatFk = createNumber("DMALM_UNITAORG_FLAT_FK_03", Integer.class);
	...
	public final StringPath stato = createString("STATO_PRODOTTO");
