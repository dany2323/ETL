...
/**
 * QDmalmProgettoSviluppoSvil is a Querydsl query type for DmalmProgettoSviluppoSvil
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDmalmProgettoSviluppoSvil extends com.mysema.query.sql.RelationalPathBase<DmalmProgettoSviluppoSvil> {

    private static final long serialVersionUID = -1960859531;

    public static final QDmalmProgettoSviluppoSvil dmalmProgettoSviluppoSvil = new QDmalmProgettoSviluppoSvil("DMALM_PROGETTO_SVILUPPO_SVIL");
    ...
    public final NumberPath<Long> dmalmProgSvilSPk = createNumber("DMALM_PROG_SVIL_S_PK", Long.class);
    ...
    public final StringPath changed = createString("CHANGED");    
        ...
        public final StringPath uri = createString("URI_PROGETTO_SVILUPPO_SVIL");


    public final com.mysema.query.sql.PrimaryKey<DmalmProgettoSviluppoSvil> sysC0022465 = createPrimaryKey(dmalmProgSvilSPk);
...
public final StringPath tagAlm = createString("TAG_ALM");
    ...
    public QDmalmProgettoSviluppoSvil(String variable) {
        super(DmalmProgettoSviluppoSvil.class, forVariable(variable), DmAlmConstants.DMALM_TARGET_SCHEMA, "DMALM_PROGETTO_SVILUPPO_SVIL");
    }

    public QDmalmProgettoSviluppoSvil(Path<? extends DmalmProgettoSviluppoSvil> path) {
        super(path.getType(), path.getMetadata(), DmAlmConstants.DMALM_TARGET_SCHEMA, "DMALM_PROGETTO_SVILUPPO_SVIL");
    }

    public QDmalmProgettoSviluppoSvil(PathMetadata<?> metadata) {
        super(DmalmProgettoSviluppoSvil.class, metadata, DmAlmConstants.DMALM_TARGET_SCHEMA, "DMALM_PROGETTO_SVILUPPO_SVIL");
    }
