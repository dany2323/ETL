...
public class QDmalmMpsResponsabiliOfferta extends
		com.mysema.query.sql.RelationalPathBase<DmalmMpsResponsabiliOfferta> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7680273574488677365L;

	public static final QDmalmMpsResponsabiliOfferta dmalmMpsResponsabiliOfferta = new QDmalmMpsResponsabiliOfferta(
			"MPS_BO_RESPONSABILI_OFFERTA");
	...
	public QDmalmMpsResponsabiliOfferta(String variable) {
		super(DmalmMpsResponsabiliOfferta.class, forVariable(variable),
				DmAlmConstants.DMALM_TARGET_SCHEMA,
				"MPS_BO_RESPONSABILI_OFFERTA");
	}

	public QDmalmMpsResponsabiliOfferta(
			Path<? extends DmalmMpsResponsabiliOfferta> path) {
		super(path.getType(), path.getMetadata(),
				DmAlmConstants.DMALM_TARGET_SCHEMA,
				"MPS_BO_RESPONSABILI_OFFERTA");
	}

	public QDmalmMpsResponsabiliOfferta(PathMetadata<?> metadata) {
		super(DmalmMpsResponsabiliOfferta.class, metadata,
				DmAlmConstants.DMALM_TARGET_SCHEMA,
				"MPS_BO_RESPONSABILI_OFFERTA");
	}
