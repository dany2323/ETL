...
import lispa.schedulers.action.DmAlmCheckAnnullamenti;
...
//		StgMisuraDAO.FillStgMisura();
		Timestamp dataEsecuzione = DateUtils.stringToTimestamp("2019-07-15 23:40:00.0", "yyyy-MM-dd HH:mm:00");
		DataEsecuzione.getInstance().setDataEsecuzione(dataEsecuzione);
