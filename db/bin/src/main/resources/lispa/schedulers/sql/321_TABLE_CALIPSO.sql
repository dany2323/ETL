...
CREATE TABLE DMALM_STG_CALIPSO_SCHEDA_SERVZ (
	...
	COD_SCHEDA_SERVIZIO VARCHAR(100),
	...
	STATO_SERVIZIO VARCHAR2(200),
	TIPOLOGIA_STRUTTURA VARCHAR2(200),
	CLASSE_SERVIZIO VARCHAR2(200),
...
CREATE TABLE DMALM_CALIPSO_SCHEDA_SERVIZIO (
    DMALM_SCHEDA_SERVIZIO_PK NUMBER(15,0) PRIMARY KEY,
	COD_SCHEDA_SERVIZIO VARCHAR(100),
    SERVIZIO_BUSINESS VARCHAR2(4000),
	CLIENTE VARCHAR2(200),
	...
	DATA_CARICAMENTO TIMESTAMP,
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVIZIO_01 FOREIGN KEY (DMALM_CALIPSO_STATO_SERVZ_FK) REFERENCES DMALM_CALIPSO_STATO_SERVIZIO(DMALM_CALIPSO_STATO_SERVZ_PK),
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVIZIO_02 FOREIGN KEY (DMALM_CALIPSO_TIPLG_STRUTTR_FK) REFERENCES DMALM_CALIPSO_TIPLG_STRUTTURA(DMALM_CALIPSO_TIPLG_STRUTTR_PK),
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVIZIO_03 FOREIGN KEY (DMALM_CALIPSO_CLASSE_SERVZ_FK) REFERENCES DMALM_CALIPSO_CLASSE_SERVIZIO(DMALM_CALIPSO_CLASSE_SERVZ_PK)
);
...
CREATE TABLE DMALM_CALIPSO_AMBT_SCHED_SERVZ (
	...
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0),
...
CREATE TABLE DMALM_CALIPSO_SCH_SERVZ_PERSNL (
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0),
	DMALM_EL_PERSONALE_FK NUMBER(15,0),
	TIPO_PERSONALE VARCHAR2(200),
	DATA_INIZIO_VALIDITA DATE,
	DATA_FINE_VALIDITA DATE,
	CONSTRAINT PK_CALIPSO_SCHEDA_SERVZ_PER PRIMARY KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK, DMALM_EL_PERSONALE_FK, TIPO_PERSONALE, DATA_INIZIO_VALIDITA),
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVZ_PER_01 FOREIGN KEY (DMALM_EL_PERSONALE_FK) REFERENCES DMALM_EL_PERSONALE(DMALM_PERSONALE_PK),
...
CREATE TABLE DMALM_CALIPSO_SCH_SERVZ_MODULI (
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0),
	DMALM_MODULO_FK NUMBER(15,0),
	DATA_INIZIO_VALIDITA DATE,
	DATA_FINE_VALIDITA DATE,
	CONSTRAINT PK_CALIPSO_SCHEDA_SERVZ_MOD PRIMARY KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK, DMALM_MODULO_FK, DATA_INIZIO_VALIDITA),
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVZ_MOD_01 FOREIGN KEY (DMALM_MODULO_FK) REFERENCES DMALM_EL_MODULI(DMALM_MODULO_PK),
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVZ_MOD_02 FOREIGN KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK) REFERENCES DMALM_CALIPSO_SCHEDA_SERVIZIO(DMALM_SCHEDA_SERVIZIO_PK)
);

CREATE TABLE T_DMALM_CALIPSO_SCH_SER_MODULI (
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0),
	DMALM_MODULO_FK NUMBER(15,0),
	DATA_INIZIO_VALIDITA DATE,
	DATA_FINE_VALIDITA DATE,
	CONSTRAINT PK_T_CALIPSO_SCHEDA_SERVZ_MOD PRIMARY KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK, DMALM_MODULO_FK, DATA_INIZIO_VALIDITA)
);

CREATE TABLE DMALM_CALIPSO_SCH_SERVZ_PRODTT (
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0),
	DMALM_PRODOTTO_FK NUMBER(15,0),
	DATA_INIZIO_VALIDITA DATE,
	DATA_FINE_VALIDITA DATE,
	CONSTRAINT PK_CALIPSO_SCHEDA_SERVZ_PRO PRIMARY KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK, DMALM_PRODOTTO_FK, DATA_INIZIO_VALIDITA),
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVZ_PRO_01 FOREIGN KEY (DMALM_PRODOTTO_FK) REFERENCES DMALM_EL_PRODOTTI_ARCH(DMALM_PRODOTTO_PK),
	CONSTRAINT FK_CALIPSO_SCHEDA_SERVZ_PRO_02 FOREIGN KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK) REFERENCES DMALM_CALIPSO_SCHEDA_SERVIZIO(DMALM_SCHEDA_SERVIZIO_PK)
);

CREATE TABLE T_DMALM_CALIPSO_SCH_SER_PRODTT (
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0),
	DMALM_PRODOTTO_FK NUMBER(15,0),
	DATA_INIZIO_VALIDITA DATE,
	DATA_FINE_VALIDITA DATE,
	CONSTRAINT PK_T_CALIPSO_SCHEDA_SERVZ_PRO PRIMARY KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK, DMALM_PRODOTTO_FK, DATA_INIZIO_VALIDITA)
);

CREATE TABLE T_DMALM_CALIPSO_AMB_SCHED_SERV (
	DMALM_CALIPSO_AMBITO_FK NUMBER(15,0),
	DMALM_CALIPSO_SCHEDA_SERVZ_FK VARCHAR(100),
	DATA_INIZIO_VALIDITA DATE,
	DATA_FINE_VALIDITA DATE,
	CONSTRAINT PK_T_CALIPSO_AMBT_SCHED_SERVZ PRIMARY KEY (DMALM_CALIPSO_AMBITO_FK, DMALM_CALIPSO_SCHEDA_SERVZ_FK, DATA_INIZIO_VALIDITA)
);

CREATE TABLE T_DMALM_CALIPSO_SCH_SERV_PERSN (
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0),
	DMALM_EL_PERSONALE_FK NUMBER(15,0),
	TIPO_PERSONALE VARCHAR2(200),
	DATA_INIZIO_VALIDITA DATE,
	DATA_FINE_VALIDITA DATE,
	CONSTRAINT PK_T_CALIPSO_SCHEDA_SERVZ_PER PRIMARY KEY (DMALM_CALIPSO_SCHEDA_SERVZ_FK, DMALM_EL_PERSONALE_FK, TIPO_PERSONALE, DATA_INIZIO_VALIDITA)
);

CREATE TABLE DMALM_CALIPSO_COM_SW_NOT_FOUND(
	DMALM_CALIPSO_SCHEDA_SERVZ_FK NUMBER(15,0), 
	COMPONENTE_SOFTWARE VARCHAR2(100 BYTE), 
