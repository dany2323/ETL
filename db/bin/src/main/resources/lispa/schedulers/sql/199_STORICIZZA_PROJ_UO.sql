SPOOL 199_STORICIZZA_PROJ_UO.log
SET DEFINE OFF;
SET ECHO ON;
SET TIMING ON;
SET TIME ON;
SET SQLBLANKLINES ON;
CREATE OR REPLACE PROCEDURE STORICIZZA_PROJ_UO (V_PROJECT DMALM_PROJECT%ROWTYPE,V_UO DMALM_UNITA_ORGANIZZATIVA.DMALM_UNITA_ORG_PK%TYPE ) IS
