SPOOL 259_DMALM_EL_PERSONALE.log
SET DEFINE OFF;
SET ECHO ON;
SET TIMING ON;
SET TIME ON;
...
CREATE UNIQUE INDEX DMALM_EL_PERSONALE_PK ON DMALM_EL_PERSONALE
(DMALM_PERSONALE_PK)
    TABLESPACE "TS_ALM" 
    PCTFREE 10 
    MAXTRANS 255 
...
ALTER TABLE DMALM_EL_PERSONALE ADD (
  CONSTRAINT DMALM_EL_PERSONALE_PK
  PRIMARY KEY
  (DMALM_PERSONALE_PK)
  USING INDEX DMALM_EL_PERSONALE_PK);
SPOOL OFF;
